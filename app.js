...
function sweetTooth(TotalNoOfSweets,sweetsConsumedByKaren,SweetsConsumedInNMeters,metersToTravl){
    var remaining = (TotalNoOfSweets-(sweetsConsumedByKaren+SweetsConsumedInNMeters*metersToTravl))/2;
    return remaining;
}
...
function aDifficultChoice(value){
    switch(value){
        ...
        case 3:
            return "ounsel her daughter herself"
        case 4:
